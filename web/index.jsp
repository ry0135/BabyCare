    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Dịch vụ chúng tôi cung cấp (Đang Phát Triển)</h6>
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Massage (Đang Phát Triển)</h5>
                            <p>Đặt lịch dịch vụ massage</p>
                            <a class="text-primary text-uppercase" href="update.jsp">Xem ngay<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Triệt sản (Đang Phát Triển)</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Cắt tỉa lông (Đang Phát Triển)</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Vệ sinh tai (Đang Phát Triển)</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Tắm rửa vệ sinh thú cưng (Đang Phát Triển)</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Tiêm phòng (Đang Phát Triển)</h5>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel bg-white p-5">
                        <div class="testimonial-item text-center">
                            ...
                            <h5 class="text-uppercase">Đặng Phương Nam</h5>
                            <span>Khách hàng</span>
                        </div>
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-4">
                                <img class="img-fluid mx-auto" src="img/team-5.jpg" alt="">
                                <div class="position-absolute top-100 start-50 translate-middle d-flex align-items-center justify-content-center bg-white" style="width: 45px; height: 45px;">
                                    <i class="bi bi-chat-square-quote text-primary"></i>
                                </div>
                            </div>
                            ...
                            <hr class="w-25 mx-auto">
                            <h5 class="text-uppercase">Phạm Võ Thế Anh</h5>
                            <span>Khách hàng</span>
                        </div>
                        <div class="testimonial-item text-center">
                            <div class="position-relative mb-4">
                            ...
                            <p> Cửa hàng không chỉ cung cấp sản phẩm chất lượng mà còn tạo ra một môi trường chuyên nghiệp và tận tâm đối với khách hàng. Nhân viên của cửa hàng luôn tỏ ra tình cảm và chu đáo, mang lại sự chăm sóc đặc biệt cho thú cưng của bạn.</p>
                            <hr class="w-25 mx-auto">
                            <h5 class="text-uppercase">Nguyễn Đắc Phong</h5>
                            <span>Khách hàng Thân Thuộc</span>
                        </div>
                    </div>
                </div>
            </div>
